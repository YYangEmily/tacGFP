...
i <- read_excel("~/Documents/Experiments/9.16.25 BizioGFP.xlsx", 
    sheet = "Lum OD")
m <- read_excel("~/Documents/Experiments/9.16.25 BizioGFP.xlsx", 
    sheet = "Avg Lum")
n <- read_excel("~/Documents/Experiments/9.16.25 BizioGFP.xlsx", 
    sheet = "Avg OD")
o <- read_excel("~/Documents/Experiments/9.16.25 BizioGFP.xlsx", 
    sheet = "Avg LO")
...
p1 <- ggplot(g, aes(x=Hours)) + 
  ...
  geom_line(aes(y = E7, color="115"),linewidth=1)+
  xlim(2,18)+
   labs(title="Smar Bizio 102-115 GFP",
        x ="Time (hours)", y = "GFP (AU)",
         color = "Legend") +
    scale_color_manual(values = colors)
p1
#ggsave("Bizio GFP.png")
...
p1 <- ggplot(h, aes(x=Hours)) + 
 geom_line(aes(y = A1, color="102"),linewidth=1) +
  ...
  xlim(2,18)+
  scale_y_log10()+
   labs(title="Smar Bizio 102-115 OD",
...
r<- ggplot()+ 
 ...
 geom_point(data = data.frame(x = h$C7, y = g$C7), aes(x = x, y = y, color="115"))+
  ...
  xlim(0,1)+ylim(0,400000)+
labs(title="Smar Bizio 102-115 OVL",
        x ="Optical Density", y = "GFP (AU)", color = "Legend") +
    scale_color_manual(values = colors)
r

#ggsave("Bizio OVL.png")
...
p1 <- ggplot(i, aes(x=Hours)) + 
 geom_line(aes(y = A1, color="102"),linewidth=1) +
  ...
  geom_line(aes(y = E7, color="115"),linewidth=1)+
  xlim(2,18)+
   labs(title="Smar Bizio 102-115 GFP/OD",
        x ="Time (hours)", y = "GFP/OD",
         color = "Legend") +
    scale_color_manual(values = colors)
p1
#ggsave("Bizio GFPOD.png")
```
...
p1 <- ggplot(m, aes(x=Hours)) + 
  ...
  geom_line(aes(y = D1, color="115"),linewidth=1)+
    xlim(2,18)+
   labs(title="Avg Bizio GFP",
        x ="Time (hours)", y = "GFP (AU)",
         color = "Legend") +
    scale_color_manual(values = colors)
p1
#ggsave("Avg Bizio GFP.png")
...
p1 <- ggplot(n, aes(x=Hours)) + 
  ...
  geom_line(aes(y = D1, color="115"),linewidth=1) +
    xlim(2,18)+
  scale_y_log10()+
   labs(title="Avg Bizio OD",
        x ="Time (hours)", y = "Log OD",
         color = "Legend") +
    scale_color_manual(values = colors)
p1
#ggsave("Avg Bizio OD.png")
```
...
p1 <- ggplot(o, aes(x=Hours)) + 
  ...
  geom_line(aes(y = D1, color="115"),linewidth=1) +
    xlim(2,18)+
   labs(title="Avg Bizio GFP/OD",
        x ="Time (hours)", y = "GFP/OD",
         color = "Legend") +
    scale_color_manual(values = colors)
p1

#ggsave("Avg Bizio GFPOD.png")
```
...
ggplotRegression(lm( A1 ~ Hours, data = m, subset=(Hours>2 & Hours<16)))
